...
class Complejo{
 ...
 public:
  ...
  Complejo add(Complejo complejo1,unsigned int numero);   //MODIFICACION  COMPLEJO + NATURAL
  Complejo add(Complejo complejo1,float numero);     //MODIFICACION  COMPLEJO + REAL
...
Complejo Complejo::add(Complejo _complejo1,unsigned int numero ){    //MODIFICACION COMPLEJO MAS UN ENTERO EL ENTERO SE SUMA AL COMPLEJO POR PETICION DEL MAESTRO

    int suma_iman = _complejo1.compleja + numero;
    Complejo suma(_complejo1.real,suma_iman);
    std::cout<<"La suma de un complejo mas un entero es: ";
    return suma;   
}
Complejo Complejo::add(Complejo _complejo1,float numero ){         //MODIFICACION COMPLEJO MAS UN REAL

    float suma_real = _complejo1.real + numero;
    Complejo suma(suma_real, _complejo1.compleja);
    std::cout<<"La suma de un complejos mas un real es: ";
    return suma;   
}
